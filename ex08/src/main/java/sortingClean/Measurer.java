...
public class Measurer {
    ...
    long total_count = 0, bubble_count = 0, insert_count = 0, quick_count = 0, merge_count = 0;
    long current_time;
    ...
    public void afterMeasurable(JoinPoint jp){
        ...
        switch (current_algo)
        {
            case "QuickSort": quick_time += current_time;quick_count++;break;
            case "BubbleSort": bubble_time += current_time;bubble_count++;break;
            case "InsertionSort": insert_time += current_time;insert_count++;break;
            case "MergeSort": merge_time += current_time;merge_count++;break;
        }
    }
